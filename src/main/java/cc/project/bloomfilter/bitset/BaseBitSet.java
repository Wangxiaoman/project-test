package cc.project.bloomfilter.bitset;

/**
 * Base bit set interface. If you want to use your own data structure you can
...
public interface BaseBitSet extends Cloneable, java.io.Serializable {
	...
	/**
	 * Returns is the bit set empty, bit set is empty means no any elements
	 * added to bit set.
	 *
