package cc.project.alipay.controller;
...
import cc.project.alipay.AlipayCore;
import cc.project.alipay.AlipayNotify;
import cc.project.alipay.model.AlipayDirectPayParams;
import cc.project.alipay.model.AlipayMobilePayParams;
...
public class AlipayTestController {
	private static Logger logger = LoggerFactory.getLogger(AlipayTestController.class);
	 ...
	 */
	@RequestMapping("/mobile/buildPayinfo")
	@ResponseBody
